...
HD_PWD='C:/Portfolio/Conception SoC/Vivado_proj/Timer_IP_Design/Timer_IP_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Write_IF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Write_IF.tcl
